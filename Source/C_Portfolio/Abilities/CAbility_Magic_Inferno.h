...
#include "CAbility_Magic_Inferno.generated.h"

UCLASS()
class C_PORTFOLIO_API ACAbility_Magic_Inferno : public ACAbility_Player
{
	GENERATED_BODY()
	
private:
	UPROPERTY(EditDefaultsOnly)
		TSubclassOf<class ACInfernoObject> InfernoClass;
