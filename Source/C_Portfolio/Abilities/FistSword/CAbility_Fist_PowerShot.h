...
#include "CAbility_Fist_PowerShot.generated.h"

UCLASS()
class C_PORTFOLIO_API ACAbility_Fist_PowerShot : public ACAbility_Player
{
	GENERATED_BODY()
	
private:
	UPROPERTY(EditDefaultsOnly)
		TSubclassOf<class ACPowerShotObject> PowerShotClass;
...
private:
	class ACPowerShotObject * PowerShot;
};
